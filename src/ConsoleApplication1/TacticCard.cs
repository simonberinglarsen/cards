        ...
        private static Dictionary<AbilityTypeEnum, string> texts = new Dictionary<AbilityTypeEnum, string>()
            {
                ...
                { AbilityTypeEnum.Carlsen, "Intuition! - du kan vinde mod enhver udfordring."},
                { AbilityTypeEnum.Caruana, "Robot! - du kan vinde mod enhver udfordring."},
                { AbilityTypeEnum.Kramnik, "Slutspiller! - du kan vinde mod enhver udfordring."},
                { AbilityTypeEnum.So, "Stjerne! - du kan vinde mod enhver udfordring."},
                { AbilityTypeEnum.VachierLagrave, "Beregner! - du kan vinde mod enhver udfordring."},
                { AbilityTypeEnum.Anand, "Hurtig! - du kan vinde mod enhver udfordring."},
            };
